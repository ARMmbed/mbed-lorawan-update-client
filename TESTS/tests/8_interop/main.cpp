...
static control_t interop_test(const size_t call_count) {
    ...
    const uint8_t expected_nwkskey[] = { 0x99, 0x77, 0xC3, 0x58, 0x28, 0x05, 0xCC, 0xA3, 0xB2, 0x51, 0xF0, 0x60, 0x9C, 0x22, 0xD6, 0x02 };
    const uint8_t expected_appskey[] = { 0xDA, 0x45, 0x0A, 0x27, 0xAF, 0x6B, 0xAD, 0xC6, 0xC2, 0xEE, 0x7A, 0x46, 0x69, 0x77, 0xEC, 0x4D };
